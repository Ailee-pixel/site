                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <a class="btn btn-success" href="dashboard_cadastro_produtos.php">Cadastrar Produtos</a>
                            </div>
                            <div class="card-body">
                                <table class = "table">
                                ...
                                <tr>
                                    ...
                                    <a href='dashboard_editar_produtos.php?id=<?php echo $busca["id_produto"]?>' class="btn btn-warning" value="Submit" >               
                                    ...
                                    <td>
                                    <a href='dashboard_deletar_produtos.php?id=<?php echo $busca["id_produto"]?>' class="btn btn-danger" value="Submit" >    
